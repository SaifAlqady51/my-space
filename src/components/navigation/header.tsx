...
export const Header = () => {
  return (
    <div className="w-full gap-4 h-16 bg-slate-950 border-b border-white/10 flex md:justify-between justify-center shadow-lg lg:px-32 xl:px-[var(--main-px)] px-8 top-0 z-50">
