export const OwlIcon = () => (
  <svg
    ...
    viewBox="0 0 360 360" // Adjusted to match your SVG's original dimensions
    width={60}
    height={60}
    fill="#b69121" // Your desired color
    className="hover:scale-110 transition-transform duration-300"
  >
    <g transform="translate(0,360) scale(0.1,-0.1)" fill="currentColor">
